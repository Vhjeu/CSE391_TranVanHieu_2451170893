...
function averageRating(products) {
    ...
    // Tính trung bình, làm tròn 1 chữ số thập phân và ép kiểu lại thành số (+)
...
console.log(sortByPrice(products, "desc").slice(0, 3)); // In thử 3 SP đắt nhất
...
console.log(formatProductList(products).slice(0, 3)); // In thử 3 SP đầu
